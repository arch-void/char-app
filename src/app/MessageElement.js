...
export const MessageElement = ({ messageId, charName, text, deleteMessage, apiURL }) => {
	...
	const handleEditBlur = async (event) => {
		...
		await MessagesApi.patch(messageId, newText, apiURL)
	...
	return (
		<div className='flex'>
			<Avatar m="0.2rem" size='xl' >
				<AvatarImage src={`/avatars/${slugify(charName)}.png`} alt={charName} />
